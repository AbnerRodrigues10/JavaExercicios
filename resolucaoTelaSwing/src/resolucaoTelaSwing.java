...
public class resolucaoTelaSwing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblResolucao.setText("Sua resolução é");

        btnClique.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        btnClique.setText("Clique para ver sua resolução");
    ...
    private void btnCliqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCliqueActionPerformed
        ...
        lblResolucao.setText("Sua resolução é " + width + "X " + height);
